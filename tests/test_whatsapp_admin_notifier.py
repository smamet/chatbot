...
from evenor.automation.handlers.admin_notifier import WhatsAppAdminNotifier
from evenor.config.settings import Settings
from evenor.domain.models.order import OrderAction
...
def test_whatsapp_admin_notifier_swallows_graph_401(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("evenor.automation.handlers.admin_notifier.send_whatsapp_text", _boom)
