...
def cac40_start_run(
    ...
    min_exit_profit_points: float = Form(0.0),
    period: str = Form("1w"),
    ...
    cfg = Cac40Config(
        ...
        min_exit_profit_points=max(0.0, float(min_exit_profit_points if min_exit_profit_points is not None else 0.0)),
