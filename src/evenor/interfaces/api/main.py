...
from evenor.adapters.rag.fasttext_language_gate import load_rewrite_language_gate
...
from evenor.interfaces.api.error_handlers import register_exception_handlers
from evenor.interfaces.api.routers import (
    admin,
    auth_web,
    chat,
    dashboard_web,
...
def create_app() -> FastAPI:
    settings = get_settings()
    app = FastAPI(title="Evenor", lifespan=lifespan)
