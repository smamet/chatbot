...
from evenor.adapters.persistence.api_usage_repository import SqlAlchemyApiUsageRepository, usage_since_date
...
from evenor.adapters.persistence.tenant_paths import tenant_catalog_dir, tenant_docs_dir
...
from evenor.application.channel_outbound import (
...
from evenor.application.email_thread_resolution import audit_from_json, format_resolution_tooltip
from evenor.application.pending_reply_inbound import inbound_for_pending_reply
from evenor.application.validation_message_ui import (
...
from evenor.application.customer_access_gate import build_channel_session_id, resolve_manual_identity
from evenor.application.customer_provisioning_service import create_erpnext_customer_for_test
...
from evenor.application.hook_prompt_composer import compose_hook_instructions
from evenor.application.monitoring_dashboard_service import MonitoringDashboardService
...
from evenor.application.draft_edit_service import (
    DraftEditError,
    save_pending_reply_draft,
    submitted_draft_matches_stored,
)
from evenor.application.outbound_orchestrator import erpnext_integration_for_tenant, queue_after_chat
from evenor.application.progress_log import ProgressLog
from evenor.application.product_resolver import resolved_lines_from_json, resolved_lines_to_json
from evenor.application.quote_fulfillment_service import (
...
from evenor.application.quote_sync_state import quote_pdf_stale_context
from evenor.automation.modules.registry import all_modules
...
from evenor.application.connector_test_service import run_connector_connection_test, run_mail_connection_test
from evenor.application.mail_inbox_preview_service import preview_mail_connection_inbox
...
from evenor.application.validation_audit_service import VALIDATION_ACTIVITY_LIMIT, ValidationAuditService
from evenor.application.validation_bulk_service import (
    ValidationBulkService,
    format_bulk_reject_summary,
    reject_pending_reply,
)
from evenor.config.settings import Settings
from evenor.domain.constants import DEFAULT_HOOK_INSTRUCTIONS
...
from evenor.domain.models.integration import Integration, IntegrationType
from evenor.domain.models.integration_schema import (
...
from evenor.interfaces.api.deps import (
    _build_chat_service,
    get_session,
    get_settings_dep,
    get_tenant_service,
)
from evenor.interfaces.web.deps import (
    get_user_service,
...
def _client_admin_test_session_cookie_name(slug: str) -> str:
    return f"evenor_test_anon_{slug}"
...
async def resolve_validation_quote(
    ...
    from evenor.adapters.erpnext.client import ErpNextClient
    from evenor.application.outbound_orchestrator import _erpnext_client_for_tenant
    from evenor.application.product_resolver import ProductResolver
    from evenor.automation.modules.erpnext.quote import parse_quote_proposal
        ...
        if _is_simulated_chat_channel(channel):
            ...
            if connector is None:
                ...
                if quote_hook is not None:
                    ...
                    from evenor.application.customer_access_gate import can_create_quotation
                    from evenor.application.outbound_orchestrator import erpnext_integration_for_tenant
