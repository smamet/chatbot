(function () {
  ...
  const identityStorageKey = botSlug ? `evenor:test-chat:${botSlug}` : "evenor:test-chat";
  const testSessionStorageKey = botSlug ? `evenor:test-session:${botSlug}` : "evenor:test-session";
